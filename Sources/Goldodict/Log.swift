...
enum Log {
    ...
    static let architect = Logger(subsystem: "fr.sztulman.goldodict", category: "architect")
    static let learning = Logger(subsystem: "fr.sztulman.goldodict", category: "learning")
}
