...
**Le menu.** Un clic sur l'icône de la barre des menus ouvre un panneau. Une carte teintée y donne l'état en tête, verte au repos, rouge pendant la dictée, orange sur incident, et réunit le profil que la prochaine dictée va viser et le raccourci en vigueur — le même sert à lancer et à arrêter. Suivent les deux boutons d'entrée, dictée et import de fichier, le choix du moteur, les autorisations manquantes s'il y en a, puis les cinq dernières dictées recopiables d'un clic. La dictée lancée depuis ce panneau revient à l'application où vous étiez, et non à Goldodict.
